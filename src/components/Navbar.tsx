...
function Navbar() {
  ...
  return (
    <div className={`fixed top-3 border-2 border-white/40 bg-black/40 backdrop-blur-xl rounded-xl z-50 overflow-hidden transition-all duration-600 ease-in-out ${isScrolled ? "inset-x-30" : "inset-x-8"}`}>
        <div className="flex justify-between items-center p-4 lg:p-8 h-18">
            ...
            <Link href="/signin" className="relative hidden lg:inline-block font-semibold ml-7 flex-shrink-0 group">
