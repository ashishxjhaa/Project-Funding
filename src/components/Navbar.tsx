...
function Navbar() {
  ...
  return (
    <div className={`fixed top-6 border-2 border-white/40 bg-white/10 backdrop-blur-xl rounded-xl z-50 overflow-hidden transition-all duration-300 ease-in-out ${isScrolled ? "inset-x-40" : "inset-x-8"}`}>
        <div className="flex justify-between items-center p-4 lg:p-8 h-22">
            <div className="h-20 flex justify-between items-center cursor-pointer">
                <Image src='/logo.svg' alt="project-funding" width={45} height={45} className="md:w-10 md:h-10" />
                <div className={`ml-2 text-3xl text-slate-100 font-semibold transition-all duration-300 ease-in-out ${isScrolled ? "lg:opacity-0 lg:w-0 lg:overflow-hidden" : "opacity-100 w-auto"}`}>ProjectFunding</div>
            </div>
            ...
            <div className="hidden lg:flex justify-between items-center gap-4 ml-10 cursor-pointer">
                <div className="text-slate-200">Updates</div>
                <div className="text-slate-200">Demo</div>
                <div className="text-slate-200">Docs</div>
                <div className="text-slate-200">Contact</div>
            </div>
            <div className={`hidden lg:flex justify-between items-center gap-6 transition-all duration-300 ease-in-out ${isScrolled ? "ml-100" : "ml-auto"}`}>
            ...
            <Link href="/" className="relative hidden lg:inline-block font-semibold ml-7">
                <span className="block rounded-md lg:p-[1.55px]" style={{background: 'linear-gradient(to right, white, green, black, white)'}}>
                    <span className="block rounded-md bg-gray-950 px-5 py-2">
                        List Your Project
                    </span>
                </span>
            </Link>
