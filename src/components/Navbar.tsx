  ...
  return (
    <div className={`fixed top-6 border-2 border-white/40 bg-white/10 backdrop-blur-xl rounded-xl z-50 overflow-hidden transition-all duration-600 ease-in-out ${isScrolled ? "inset-x-30" : "inset-x-8"}`}>
        <div className="flex justify-between items-center p-4 lg:p-8 h-22">
            ...
            <Link href="/" className="relative hidden lg:inline-block font-semibold ml-7 flex-shrink-0">
                <span className="block rounded-md lg:p-[1.55px]" style={{background: 'linear-gradient(to right, white, green, black, white)'}}>
                    <span className="block rounded-md bg-gray-950 px-5 py-2 transition-colors duration-150 hover:bg-gray-800 hover:text-white">
                        Raise Fund
                    </span>
                </span>
            </Link>
