...
function Hero() {
    return (
        <div className="w-full min-h-screen pt-28 max-md:pt-15 px-20 max-md:px-7">
            ...
            <div className="mt-45 text-5xl max-sm:text-3xl max-md:text-4xl font-bold tracking-tight leading-normal text-center bg-gradient-to-b from-orange-400 to-orange-500 bg-clip-text text-transparent">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-6 mt-12 px-10">
                <div className="w-full md:w-7/12">
                    ...
                    <div className="flex gap-3 items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-lock-icon lucide-lock w-6 h-6 text-[#FF8162]"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
                        <div className="text-slate-300">Secure funding with tailored pitches and proposals</div>
                    </div>
                    <div className="flex gap-3 items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-user-icon lucide-user w-6 h-6 text-[#FF8162]"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                        <div className="text-slate-300">Receive expert advice from top mentors in your domain</div>
                    </div>
                    <div className="flex gap-3 items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-loader-icon lucide-loader w-6 h-6 text-[#FF8162]"><path d="M12 2v4"/><path d="m16.2 7.8 2.9-2.9"/><path d="M18 12h4"/><path d="m16.2 16.2 2.9 2.9"/><path d="M12 18v4"/><path d="m4.9 19.1 2.9-2.9"/><path d="M2 12h4"/><path d="m4.9 4.9 2.9 2.9"/></svg>
                ...
                <div className="w-full md:w-5/12 p-6 bg-gray-500/20 border border-[#FF8162] rounded-md text-lg font-medium cursor-pointer hover:scale-100 hover:-translate-y-2 transition-transform duration-300">
                    <div>
                        <div className="flex mb-6 justify-between">
                            ...
                            <div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-shield-icon lucide-shield text-[#FEB57F]"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/></svg></div>
                        </div>
                        <div className="flex mb-3 justify-between">
                            <div className="flex gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-user-icon lucide-user text-[#FF8162]"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                        ...
                        <div className="flex mb-3 justify-between">
                            <div className="flex gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-eye-off-icon lucide-eye-off text-[#FF8162]"><path d="M10.733 5.076a10.744 10.744 0 0 1 11.205 6.575 1 1 0 0 1 0 .696 10.747 10.747 0 0 1-1.444 2.49"/><path d="M14.084 14.158a3 3 0 0 1-4.242-4.242"/><path d="M17.479 17.499a10.75 10.75 0 0 1-15.417-5.151 1 1 0 0 1 0-.696 10.75 10.75 0 0 1 4.446-5.143"/><path d="m2 2 20 20"/></svg>
                        ...
                        <div className="flex justify-between">
                            <div className="flex gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-lock-icon lucide-lock text-[#FF8162]"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
                                <div className="text-white">Hide project</div>
                            </div>
                            <div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-toggle-right-icon lucide-toggle-right text-red-400"><circle cx="15" cy="12" r="3"/><rect width="20" height="14" x="2" y="5" rx="7"/></svg></div>
                        </div>
                        <div className="mt-4 text-[#FEB57F] flex justify-center items-center rounded-md p-5 py-2 tracking-wider font-semibold border border-gray-300">Privacy First.</div>
                    </div>
                </div>
            </div>
            <div className="mt-35 text-5xl max-sm:text-3xl max-md:text-4xl font-bold tracking-tight leading-normal text-center bg-gradient-to-b from-orange-400 to-orange-600 bg-clip-text text-transparent">
                Latest Projects
            </div>
            ...
            <div className="mt-10 text-5xl max-sm:text-3xl max-md:text-4xl font-bold tracking-tight leading-normal text-center bg-gradient-to-b from-orange-400 to-orange-500 bg-clip-text text-transparent">
                Feedback & Review
            </div>
            <div className="px-4 mt-10 bg-gray-400/20 border border-gray-100/10 rounded-lg">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 py-10">
                    ...
                    <div className="glass-card h-[200px] w-full max-w-[420px] flex flex-col p-4 mx-auto bg-gray-950 border border-gray-100/10 rounded-lg cursor-pointer hover:scale-110 hover:-translate-y-2 transition-transform duration-300">
                    ...
                    <div className="glass-card h-[138px] w-full max-w-[420px] flex flex-col p-4 col-span-1 sm:col-span-2 lg:col-span-3 mx-auto bg-gray-950 border border-gray-100/10 rounded-lg cursor-pointer hover:scale-110 hover:-translate-y-2 transition-transform duration-300">
                        <div className="flex items-center gap-2 mb-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-user-icon lucide-user my-2 mb-1 text-orange-400"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                    ...
                    <div className="glass-card h-[180px] w-full max-w-[420px] flex flex-col p-4 mx-auto bg-gray-950 border border-gray-100/10 rounded-lg cursor-pointer hover:scale-110 hover:-translate-y-2 transition-transform duration-300">
                        <div className="flex items-center gap-2 mb-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-user-icon lucide-user my-2 mb-1 text-orange-400"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
