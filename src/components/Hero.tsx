        ...
        <div className="w-full min-h-screen pt-28 max-md:pt-15 px-20 max-md:px-7">
            ...
            <div className="px-4 mt-10 bg-gray-400/20 border border-gray-100/10 rounded-lg">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 py-10">
                    ...
                    <div className="glass-card h-[190px] w-full max-w-[420px] flex flex-col p-4 mx-auto bg-gray-950 border border-gray-100/10 rounded-lg cursor-pointer hover:scale-110 hover:-translate-y-2 transition-transform duration-300">
