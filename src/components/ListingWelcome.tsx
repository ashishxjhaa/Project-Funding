    ...
    return (
        ...
        <div className="pt-25 px-25">
            <div className="flex items-center gap-8 rounded-xl bg-[#392E34] px-14 py-4 border border-[#FF8162]">
                <div className="hidden md:flex rounded-xl bg-[#FF8162] w-[55px] h-[50px] relative flex items-center justify-center">
                ...
                <div className="flex flex-col">
                    <div className="font-semibold text-[#FF8162] tracking-wider text-xs sm:text-sm md:text-md sm:text-lg">
